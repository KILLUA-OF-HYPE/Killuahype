...
const blockedmsg = '* Desculpe mas vc não tem o direito de me usar*'
...
const botlindo = 'Mais lindo que eu só meu Dono'
const linkbotlindo = 'https://photos1.iorbix.com/00/00/00/00/02/72/43/64/C--6tZwaASQH-b.jpg'
const botfeio = 'Quieto mamaco 😡'
...
const botlixo = 'Quieto baianor'
const dono = 'Meu papai 𝕂𝕀𝕃𝕃𝕌𝔸'
// KEYS
